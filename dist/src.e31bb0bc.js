...
class Swiper extends SwiperClass {
  constructor(...args) {
    ...
    if (el && el.shadowRoot && el.shadowRoot.querySelector) {
      $wrapperEl = (0, _dom.$)(el.shadowRoot.querySelector(`.${swiper.params.wrapperClass}`)); // Children needs to return slot items
...
},{"dom7/dist/dom7.modular":"../node_modules/dom7/dist/dom7.modular.js","ssr-window":"../node_modules/ssr-window/dist/ssr-window.esm.js"}],"images/budget-planner/logo.jpg":[function(require,module,exports) {
...
var works = [// RoomFiles
{
  ...
  features: ["Make a room and invite your colleagues", "Join multiple rooms at once", "Upload your lesson files", "Make announcements to stay on track", "View and manage people in your room (if you're the room creator)", "Get notified on recent activities"],
  prefix: "roomfiles",
  images: [{
    url: _logo2.default,
    label: "RoomFiles"
    ...
    url: _announcements.default,
    label: "Make announcements for everyone to see"
  }, {
    url: _notifications.default,
...
}, // Budget Planner
{
  ...
  features: ["Day-to-day tracking of allowances and expenses", "Generate monthly summary, provide basic insight of expenditures and income", "Able to backup data to a file for later recovery", "Has a Help & Feedback feature that answers FAQs and provides an email box for suggestions"],
  prefix: "budget",
  images: [{
    url: _logo.default,
    ...
    url: _summary.default,
    label: "Generate montly overview"
  }, {
    url: _toplist.default,
    label: "View your expenses"
  }, {
    url: _savings.default,
...
}, // Edzer
{
  ...
  images: [{
    ...
    url: _dashboard.default,
    label: "Dashboard Overview"
  }, {
    url: _add.default,
    label: "Add Schedules"
  }, {
    url: _schedules.default,
    label: "Be reminded of who's next"
  }, {
    url: _instruments.default,
...
if ("content" in document.createElement("template")) {
  ...
  if (document.querySelector("#work-template") != null) {
    ...
    works.forEach(function (e) {
      ...
      var row = template.content.cloneNode(true); // Inject id to w-col

      row.querySelector(".w-col").id = "".concat(e.prefix); // Get swiper-container

      var swiperContainer = row.querySelector(".swiper-container"); // Inject {prefix}-slider class for identifying slider (Swiper.js requirement)

      swiperContainer.classList.add("".concat(e.prefix, "-slider")); // Get swiperWrapper

      var swiperWrapper = swiperContainer.querySelector(".swiper-wrapper"); // Create slide template
      ...
      tmpSlide.appendChild(imgLabel); // For each image, clone slide template and assign values

      e.images.forEach(function (img) {
        // Clone swiper slide template
        var slide = tmpSlide.cloneNode(true); // Get img tag and assign src

        var divImg = slide.querySelector("img");
        divImg.src = img.url; // Get img-label and assign label

        var divLabel = slide.querySelector(".img-label");
        divLabel.innerText = img.label; // Append to swiper wrapper

        swiperWrapper.appendChild(slide);
      }); // Inject pagination class

      var pagination = swiperContainer.querySelector(".swiper-pagination");
      pagination.classList.add("".concat(e.prefix, "-pagination")); // Inject Title, Stack

      var title = row.querySelector(".w-title");
      title.innerText = "".concat(e.title);
      var stack = row.querySelector(".w-stack");
      stack.innerText = "".concat(e.stack, " | ").concat(e.date_dev); // Inject id={prefix}-p, Description

      var divDescContainer = row.querySelector(".w-p");
      var divDescription = divDescContainer.querySelector("div");
      divDescription.innerHTML = e.description;
      var featureHeader = document.createElement('h4');
      featureHeader.classList.add('list-header');
      featureHeader.innerText = 'Features'; // Inject features list
      ...
      var divLinks = row.querySelector(".w-links"); // Create li link template

      var tmpLinkItem = document.createElement("li");
      tmpLinkItem.appendChild(document.createElement("a")).appendChild(document.createElement("img")); // For each link, clone link item template then append to divLinks

      e.links.forEach(function (l) {
        // Clone template first
        var linkItem = tmpLinkItem.cloneNode(true); // Inject Links with url and class (for image)

        var linkA = linkItem.querySelector("a");
        linkA.href = l.url;
        linkA.target = '_blank';
        ...
        if (l.disabled) {
          ...
          if (l.site === 'open') {
            var _openlink = document.createElement('a');
      ...
      var toggle = row.querySelector(".w-toggle");
  ...
  if (document.querySelector("#skill-template") != null) {
    ...
    var template = document.querySelector("#skill-template"); // Foreach skill, create li, append to #ul-skillset

    skills.forEach(function (s) {
      var item = template.content.cloneNode(true); // Inject skill-name and a.href

      var skillNameDiv = item.querySelector(".skill-name");
      var skillLink = skillNameDiv.querySelector("a");
      skillLink.innerText = s.name;

      if (s.projectExample) {
        skillLink.href = "./works.html#".concat(s.projectExample);
        skillLink.classList.add('underline');
      } // Inject skill percentage id


      var skillPercentage = skillNameDiv.querySelector("span");
      skillPercentage.id = "".concat(s.language, "-value"); // Set width according to progress

      var progressbar = item.querySelector(".progress-bar-container");
      progressbar.style.width = "".concat(s.progress, "%");
...
} else {// TODO: Callback function if does not support templates
...
var sliderPrefixes = works.map(function (work) {
  return work.prefix;
});

var _iterator = _createForOfIteratorHelper(sliderPrefixes),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var prefix = _step.value;
    new _swiper.default(".".concat(prefix, "-slider"), _objectSpread(_objectSpread({}, sliderOpts), {}, {
      pagination: {
        el: ".".concat(prefix, "-pagination"),
        type: "bullets"
      }
    }));
  }
...
var selfSwiper = new _swiper.default(".self-swiper", {
  pagination: {
...
},{"swiper":"../node_modules/swiper/js/swiper.esm.bundle.js","./images/budget-planner/logo.jpg":"images/budget-planner/logo.jpg","./images/budget-planner/dark.jpg":"images/budget-planner/dark.jpg","./images/budget-planner/summary.jpg":"images/budget-planner/summary.jpg","./images/budget-planner/toplist.jpg":"images/budget-planner/toplist.jpg","./images/budget-planner/savings.jpg":"images/budget-planner/savings.jpg","./images/budget-planner/help.jpg":"images/budget-planner/help.jpg","./images/budget-planner/backup.jpg":"images/budget-planner/backup.jpg","./images/roomfiles/logo.jpg":"images/roomfiles/logo.jpg","./images/roomfiles/files.jpg":"images/roomfiles/files.jpg","./images/roomfiles/announcements.jpg":"images/roomfiles/announcements.jpg","./images/roomfiles/notifications.jpg":"images/roomfiles/notifications.jpg","./images/roomfiles/people.jpg":"images/roomfiles/people.jpg","./images/roomfiles/room.jpg":"images/roomfiles/room.jpg","./images/roomfiles/rooms.png":"images/roomfiles/rooms.png","./images/edzer/logo.png":"images/edzer/logo.png","./images/edzer/add.jpg":"images/edzer/add.jpg","./images/edzer/dashboard.jpg":"images/edzer/dashboard.jpg","./images/edzer/instruments.jpg":"images/edzer/instruments.jpg","./images/edzer/login.jpg":"images/edzer/login.jpg","./images/edzer/schedules.jpg":"images/edzer/schedules.jpg"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
