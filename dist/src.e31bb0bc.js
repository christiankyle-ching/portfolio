...
exports.__PRIVATE_registerFirestore = kc;
...
function x(t) {
  ...
  if (A.logLevel <= _logger.LogLevel.DEBUG) {
    var i = e.map(S);
    A.debug.apply(A, (0, _tslib.__spreadArrays)(["Firestore (8.1.1): " + t], i));
  }
}
...
function k(t) {
  ...
  if (A.logLevel <= _logger.LogLevel.ERROR) {
    var i = e.map(S);
    A.error.apply(A, (0, _tslib.__spreadArrays)(["Firestore (8.1.1): " + t], i));
  }
}
...
function O(t) {
  ...
  if (A.logLevel <= _logger.LogLevel.WARN) {
    var i = e.map(S);
    A.warn.apply(A, (0, _tslib.__spreadArrays)(["Firestore (8.1.1): " + t], i));
  }
}
/**
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.L = function (t, e, r) {
    return new n(t, e, r);
...
function Re(t) {
  ...
  n.limit && (a = function (t) {
    var e;
    return tt(e = "object" == _typeof(t) ? t.value : t) ? null : e;
  }(n.limit));
  var c = null;
...
function () {
  ...
  function t(e, n, r) {
    ...
    // log on 12.2.
    12.2 === t.js((0, _util.getUA)()) && k("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
...
function () {
  ...
  t.prototype.Ar = function (t, e) {
    ...
    return this.wr(t, this.params.Zi).next(function (e) {
      ...
      return c = Date.now(), D() <= _logger.LogLevel.DEBUG && x("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (a - s) + "ms\n\tRemoved " + t + " documents in " + (c - a) + "ms\nTotal Duration: " + (c - f) + "ms"), lr.resolve({
        zi: !0,
        Hi: r,
        Ji: i,
        Yi: t
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.Zn = function (t) {
    var e = this,
        n = [],
        r = 0,
...
var Li = (0, _tslib.__spreadArrays)((0, _tslib.__spreadArrays)((0, _tslib.__spreadArrays)((0, _tslib.__spreadArrays)([_i.store, Ii.store, Ei.store, Ai.store, xi.store, bi.store, Oi.store, ki.store], [Ci.store]), [Di.store]), [Si.store]), [Ri.store, Vi.store]),
    Ui =
/** @class */
function () {
  function t(t) {
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.ou = function (t) {
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), Object.defineProperty(n.prototype, "fu", {
    /**
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.mu = function () {
...
function () {
  ...
  return t.Ia = function (e, n) {
    for (var r = JSON.parse(n), i = "object" == _typeof(r) && r.activeTargetIds instanceof Array, o = kt(), u = 0; i && u < r.activeTargetIds.length; ++u) {
...
function () {
  ...
  return t.Ia = function (e) {
    var n = JSON.parse(e);
    return "object" == _typeof(n) && -1 !== ["Unknown", "Online", "Offline"].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (k("SharedClientState", "Failed to parse online state: " + e), null);
  }, t;
}(),
    hu =
/** @class */
...
function () {
  ...
  return t.prototype.Mc = function (t) {
    ...
    return function (t) {
      ...
      var s = i.el(e, o);
      return (Rn(e) || Vn(e)) && i.ph(e.limitType, s, r, n) ? i.tl(t, e) : (D() <= _logger.LogLevel.DEBUG && x("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Gn(e)), i.Zh.ws(t, e, n).next(function (t) {
  ...
  t.prototype.ph = function (t, e, n, r) {
    ...
    return D() <= _logger.LogLevel.DEBUG && x("IndexFreeQueryEngine", "Using full collection scan to execute query:", Gn(e)), this.Zh.ws(t, e, H.min());
  }, t;
}(),
    Ju =
/** @class */
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.Ll = function (t, e, n, r) {
    ...
    return I(s, _webchannelWrapper.WebChannel.EventType.OPEN, function () {
      v || x("Connection", "WebChannel transport opened.");
    }), I(s, _webchannelWrapper.WebChannel.EventType.CLOSE, function () {
      v || (v = !0, x("Connection", "WebChannel transport closed"), y.Nl());
    }), I(s, _webchannelWrapper.WebChannel.EventType.ERROR, function (t) {
      v || (v = !0, O("Connection", "WebChannel transport errored:", t), y.Nl(new L(V.UNAVAILABLE, "The operation could not be completed")));
    }), I(s, _webchannelWrapper.WebChannel.EventType.MESSAGE, function (t) {
      var e;
    ...
    }), I(i, _webchannelWrapper.Event.STAT_EVENT, function (t) {
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.u_ = function (t) {
    if (2
    /* MergeSet */
    !== t.a_) throw 1
    /* Update */
    ...
    this.m_ = new Rs(t), void 0 !== t.credentials && (this.P_ = function (t) {
      ...
      switch (t.type) {
        case "gapi":
          ...
          return C(!("object" != _typeof(e) || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new F(e, t.sessionIndex || "0");
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.F_ = function (t) {
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.D_ = function () {
...
function ea(t) {
  ...
  var c = {
    includeMetadataChanges: !1
      ...
      h = 0;
  "object" != _typeof(s[h]) || yr(s[h]) || (c = s[h], h++);
  var f,
      l,
      p,
      d = {
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.sf = function (t) {
...
function pa(t, e, n, r) {
  ...
  return function (t, e, n, r, i, o) {
    ...
    for (var s = [], a = 0; a < i.length; a++) {
      ...
      if (u[a].field.tt()) {
        if ("string" != typeof c) throw new L(V.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + _typeof(c));
...
function wa(t, e) {
  ...
  if (ys("collection", "path", e), t instanceof Vs) {
    var o = $.Y.apply($, (0, _tslib.__spreadArrays)([e], n));
  ...
  var u = $.Y.apply($, (0, _tslib.__spreadArrays)([t.path], n)).child($.Y(e));
...
function ba(t, e) {
  ...
  if (!(t instanceof ia || t instanceof ga)) throw new L(V.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
  var u = t.nf.child($.Y.apply($, (0, _tslib.__spreadArrays)([e], n)));
...
function Ua(t) {
  return !("object" != _typeof(t) || null === t || t instanceof Array || t instanceof Date || t instanceof Q || t instanceof Ss || t instanceof Ps || t instanceof ia || t instanceof Ts);
}
...
function Fa(t, e, n) {
  ...
  try {
    return new (Gs.bind.apply(Gs, (0, _tslib.__spreadArrays)([void 0], e.split("."))))().G_;
  } catch (r) {
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.get = function (t) {
    var n = this,
        r = oc(t, this.U_),
        i = new Zs(this.U_);
...
function (r) {
  ...
  return (0, _tslib.__extends)(i, r), Object.defineProperty(i.prototype, "R_", {
    get: function get() {
      return this.o_.R_;
    },
    enumerable: !1,
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.get = function (t) {
    ...
    var s = Tc(t);
    return 2 === arguments.length ? this.o_.update(s, e) : (i = this.o_).update.apply(i, (0, _tslib.__spreadArrays)([s, e, n], o)), this;
...
function (e) {
  ...
  return (0, _tslib.__extends)(n, e), n.prototype.set = function (t, e, n) {
    var r = Tc(t);
...
function (i) {
  ...
  return (0, _tslib.__extends)(o, i), o.zf = function (t, e, n) {
    ...
    try {
      return 1 === arguments.length ? ta(this.o_, t) : ta.apply(void 0, (0, _tslib.__spreadArrays)([this.o_, t, e], n));
    } catch (t) {
...
function vc(t) {
  for (var e = 0, n = t; e < n.length; e++) {
    var r = n[e];
    if ("object" == _typeof(r) && !yr(r)) return r;
  }
...
function (r) {
  ...
  return (0, _tslib.__extends)(i, r), i.prototype.where = function (t, e, n) {
    try {
...
function (e) {
  ...
  function n() {
    ...
    return e.call(this, new (Gs.bind.apply(Gs, (0, _tslib.__spreadArrays)([void 0], t)))()) || this;
  }
...
},{"@firebase/firestore":"../node_modules/@firebase/firestore/dist/index.esm.js"}],"../node_modules/@firebase/storage/dist/index.esm.js":[function(require,module,exports) {
"use strict";
...
require("firebase/storage"); // Your web app's Firebase configuration
...
var _db = _app.default.firestore();

var _storage = _app.default.storage();

var _default = _db;
exports.default = _default;
var storage = _storage;
exports.storage = storage;
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/firestore":"../node_modules/firebase/firestore/dist/index.esm.js","firebase/storage":"../node_modules/firebase/storage/dist/index.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _skills = _firebase.default.collection('skills').get();
...
function _buildSkillItem(skillData, itemTemplate) {
  ...
  if (skillData.projectExample) {
    skillLink.href = "./works.html#".concat(skillData.projectExample);
    skillLink.classList.add('underline');
  } // Inject skill percentage id


  var skillPercentage = skillNameDiv.querySelector("span");
  skillPercentage.id = "".concat(skillData.language, "-value"); // Set width according to progress

  var progressbar = itemTemplate.querySelector(".progress-bar-container");
  progressbar.style.width = "".concat(skillData.progress, "%");
  return itemTemplate;
}
...
function _animatePercentage(skillData) {
  ...
  setTimeout(function () {
    animateValue("".concat(skillData.language, "-value"), skillData.progress, animDurationms);
  }, delay);
...
if ("content" in document.createElement("template")) {
  if (document.querySelector("#skill-template") != null) {
    ...
    var skillsRef = _firebase.default.collection('skills');

    skillsRef.get().then(function (skills) {
...
},{"./firebase":"firebase.js","firebase/firestore":"../node_modules/firebase/firestore/dist/index.esm.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
