...
},{"dom7/dist/dom7.modular":"../node_modules/dom7/dist/dom7.modular.js","ssr-window":"../node_modules/ssr-window/dist/ssr-window.esm.js"}],"works.js":[function(require,module,exports) {
...
function _buildWorkItem(work, itemTemplate) {
  // Inject id to w-col
  itemTemplate.querySelector(".w-col").id = "".concat(work.prefix); // Get swiper-container

  var swiperContainer = itemTemplate.querySelector(".swiper-container"); // Inject {prefix}-slider class for identifying slider (Swiper.js requirement)

  swiperContainer.classList.add("".concat(work.prefix, "-slider")); // Get swiperWrapper
  ...
  work.images.forEach(function (img, index) {
  ...
  pagination.classList.add("".concat(work.prefix, "-pagination")); // Inject Title, Stack

  var title = itemTemplate.querySelector(".w-title");
  title.innerText = "".concat(work.title);
  var stack = itemTemplate.querySelector(".w-stack");
  stack.innerText = "".concat(work.stack, " | ").concat(work.date_dev); // Inject id={prefix}-p, Description

  var divDescContainer = itemTemplate.querySelector(".w-p");
  var divDescription = divDescContainer.querySelector("div");
  divDescription.innerHTML = work.description;
  divDescription.querySelectorAll('a').forEach(function (e) {
  ...
  if (work.features) {
    ...
    work.features.forEach(function (f) {
  ...
  var divLinks = itemTemplate.querySelector(".w-links"); // Create li link template
  ...
  var toggle = itemTemplate.querySelector(".w-toggle");
...
if ("content" in document.createElement("template")) {
  ...
  if (document.querySelector("#work-template") != null) {
    ...
    _globals.default.works.forEach(function (work) {
      // Clone template content
      var rowItem = template.content.cloneNode(true);
...
var sliderPrefixes = _globals.default.works.map(function (work) {
  return work.prefix;
});
...
},{"./globals":"globals.js","swiper":"../node_modules/swiper/js/swiper.esm.bundle.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","works.js"], null)
//# sourceMappingURL=/works.90ea4f23.js.map